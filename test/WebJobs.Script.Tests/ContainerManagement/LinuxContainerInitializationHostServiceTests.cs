...
namespace Microsoft.Azure.WebJobs.Script.Tests.ContainerManagement
{
    public class LinuxContainerInitializationHostServiceTests : IDisposable
    {
        ...
        public void Runs_In_Linux_Container_Mode_Only()
        {
            ...
            initializationHostService.StartAsync(CancellationToken.None).Wait();
        ...
        public void Assigns_Context_From_CONTAINER_START_CONTEXT()
        {
            ...
            {
                _initializationHostService.StartAsync(CancellationToken.None).Wait();
            }
        ...
        public void Assigns_Context_From_CONTAINER_START_CONTEXT_SAS_URI_If_CONTAINER_START_CONTEXT_Absent()
        {
            ...
            using (var env = new TestScopedEnvironmentVariable(vars))
            {
                initializationHostService.Object.StartAsync(CancellationToken.None).Wait();
            }
