...
namespace Microsoft.Azure.WebJobs.Script.Tests.Integration.ContainerManagement
{
    ...
    public class LinuxContainerInitializationHostServiceTests : IDisposable
    {
        ...
        public async Task Assigns_Context_From_CONTAINER_START_CONTEXT()
        {
            ...
            _instanceManagerMock.Setup(manager => manager.StartAssignment(It.Is<HostAssignmentContext>(context => hostAssignmentContext.Equals(context)), null)).Returns(true);
            ...
            _instanceManagerMock.Verify(manager => manager.StartAssignment(It.Is<HostAssignmentContext>(context => hostAssignmentContext.Equals(context)), null), Times.Once);
        }
        ...
        public async Task Does_Not_Assign_If_Context_Not_Available()
        {
            ...
            _instanceManagerMock.Verify(manager => manager.StartAssignment(It.IsAny<HostAssignmentContext>(), null), Times.Never);
        }
