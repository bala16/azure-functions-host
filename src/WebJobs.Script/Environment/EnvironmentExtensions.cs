...
namespace Microsoft.Azure.WebJobs.Script
{
    internal static class EnvironmentExtensions
    {
        ...
        public static string FunctionsWorkerRuntime(this IEnvironment environment)
        {
        ...
        {
            return string.Equals(environment.FunctionsWorkerRuntime(), RpcWorkerConstants.PowerShellLanguageWorkerName,
