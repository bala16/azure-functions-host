...
namespace Microsoft.Azure.WebJobs.Script.WebHost.Diagnostics
{
    public class LinuxAppServiceFileLoggerFactory
    {
        ...
        private readonly ILinuxAppServiceFileSystem _linuxAppServiceFileSystem;
        private readonly string _logRootPath;

        public LinuxAppServiceFileLoggerFactory(ILinuxAppServiceFileSystem linuxAppServiceFileSystem)
        {
            _linuxAppServiceFileSystem = linuxAppServiceFileSystem;
        ...
        public virtual LinuxAppServiceFileLogger GetOrCreate(string category)
        {
            return Loggers.GetOrAdd(category,
                c => new Lazy<LinuxAppServiceFileLogger>(() => new LinuxAppServiceFileLogger(category, _logRootPath, _linuxAppServiceFileSystem))).Value;
        }
    }
}
