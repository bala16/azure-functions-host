...
namespace Microsoft.Azure.WebJobs.Script.WebHost.Management
{
    public class MeshServiceClient : IMeshServiceClient
    {
        ...
        public MeshServiceClient(HttpClient client, IEnvironment environment, ILogger<MeshServiceClient> logger, JsonSerializer jsonSerializer = null)
        {
            _client = client ?? throw new ArgumentNullException(nameof(client));
            _logger = logger ?? throw new ArgumentNullException(nameof(logger));
            _environment = environment ?? throw new ArgumentNullException(nameof(environment));
            _serializer = jsonSerializer ?? JsonSerializer.Create(new JsonSerializerSettings());
        }
        ...
        private string Serialize<T>(T o)
        {
            ...
            {
                _serializer.Serialize(stringWriter, o);
